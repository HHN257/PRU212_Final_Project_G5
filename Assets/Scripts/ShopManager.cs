...
public class ShopManager : MonoBehaviour
{
    ...
    void LoadUpgradeLevels()
    {
        ...
        Debug.Log($"ShopManager LoadUpgradeLevels: healthLevel={healthLevel}, attackLevel={attackLevel}");
    ...
    // Add this method to reset shop progress
    public void ResetShopProgress()
    {
        healthLevel = 1;
        attackLevel = 1;
        PlayerPrefs.DeleteKey(HEALTH_LEVEL_KEY);
        PlayerPrefs.DeleteKey(ATTACK_LEVEL_KEY);
        SaveUpgradeLevels();
        CalculateUpgradeCosts();
        UpdateUI();
    }
